...
<table>
	...
	<tbody>
			...
			<td>
				...
				<ul>
					...
					<li><strong>iframe</strong>
							...
							<ul type="disc">
								<li>원격 프록시 파일 : ajax_remote_callback.php</li>
								<li>로컬 프록시 파일 : ajax_local_callback.php</li>
							</ul>
		...
		<td style="font-weight:bold;">proxy</td>
			<td>String</td>
			<td>
				로컬 프록시 파일(ajax_local_callback.php)의 경로.<br>
		...
		<script type="text/javascript" language="javascript">
			function getList() {
				var oAjax = new $Ajax('http://server.com/some/some.php', {
					...
					proxy : 'http://local.naver.com/some/ajax_local_callback.php'
				});
				oAjax.request();
			}
...
jindo.$Ajax.FrameRequest = jindo.$Class({
	...
	send : function(data) {
		...
		var url;
		var _aStr = [];
		_aStr.push(this._remote+"/ajax_remote_callback.php?method="+this._method);
