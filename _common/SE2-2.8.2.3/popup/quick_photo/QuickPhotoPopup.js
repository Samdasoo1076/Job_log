    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/_common/SE2-2.8.2.3/popup/quick_photo/FileUploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/_common/SE2-2.8.2.3/popup/quick_photo/FileUploader.php',	//샘플 URL입니다.
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.php',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
