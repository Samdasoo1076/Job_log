...
#====================================================================
	...
	$intro_no					= isset($_POST["room_no"]) && $_POST["room_no"] !== '' ? $_POST["room_no"] : (isset($_GET["room_no"]) ? $_GET["room_no"] : '');
	$intro_title				= isset($_POST["room_name"]) && $_POST["room_name"] !== '' ? $_POST["room_name"] : (isset($_GET["room_name"]) ? $_GET["room_name"] : '');
	$intro_memo					= isset($_POST["room_dec"]) && $_POST["room_dec"] !== '' ? $_POST["room_dec"] : (isset($_GET["room_dec"]) ? $_GET["room_dec"] : '');
	...
	$file_path				= isset($_POST["file_path"]) && $_POST["file_path"] !== '' ? $_POST["file_path"] : (isset($_GET["file_path"]) ? $_GET["file_path"] : '');
	$file_size				= isset($_POST["file_size"]) && $_POST["file_size"] !== '' ? $_POST["file_size"] : (isset($_GET["file_size"]) ? $_GET["file_size"] : '');
	$hit_cnt				= isset($_POST["hit_cnt"]) && $_POST["hit_cnt"] !== '' ? $_POST["hit_cnt"] : (isset($_GET["hit_cnt"]) ? $_GET["hit_cnt"] : '');
...
#====================================================================
	...
	if ($mode == "I") {
		...
		$new_room_no	= insertIntro2($conn, $arr_data);
		$result =$new_room_no;
...
<input type="hidden" name="search_str" value="<?=$search_str?>">
				...
				<div class="cont">
					<div class="tit_h4 first"><h4>메인 팝업관리</h4></div>
					<div class="tbl_style01 left">
						<table>
							...
							<tbody>
								<tr>
									<th>팝업명 <img src="../images/img_essen.gif" alt="필수입력" /></th>
									<td colspan="3">
										<input type="text" name="intro_title" id="intro_title" value="<?=$rs_room_name?>"/>
									</td>
								</tr>
								<tr>
									<th>팝업메모 <img src="../images/img_essen.gif" alt="필수입력" /></th>
									<td colspan="3">
										<input type="text" name="intro_memo" id="intro_memo" value="<?=$rs_room_price?>"/>
									</td>
								</tr>
								<tr>
									...
									?>
										<span class="tbl_txt"><img src="/upload_data/popup/<?=$rs_room_file?>" width="200px"></span>
										&nbsp;&nbsp;
