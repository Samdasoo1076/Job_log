...
#===============================================================
	...
	$nListCnt = totalCntCompany($conn, $cp_type, $ad_type, $date_start, $date_end, $com_auth_tf, $use_tf, $del_tf, $search_field, $search_str)
	...
	$arr_rs = listJoinCompany($conn, $use_tf, $del_tf, $search_field, $search_str, $nPage, $nListCnt);
