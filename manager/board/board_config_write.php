...
#====================================================================
	...
	$board_nm				= isset($_POST["board_nm"]) && $_POST["board_nm"] !== '' ? $_POST["board_nm"] : (isset($_GET["board_nm"]) ? $_GET["board_nm"] : '');
	$board_memo			= isset($_POST["board_memo"]) && $_POST["board_memo"] !== '' ? $_POST["board_memo"] : (isset($_GET["board_memo"]) ? $_GET["board_memo"] : '');
	$board_code			= isset($_POST["board_code"]) && $_POST["board_code"] !== '' ? $_POST["board_code"] : (isset($_GET["board_code"]) ? $_GET["board_code"] : '');
	$board_type			= isset($_POST["board_type"]) && $_POST["board_type"] !== '' ? $_POST["board_type"] : (isset($_GET["board_type"]) ? $_GET["board_type"] : '');
	$board_cate			= isset($_POST["board_cate"]) && $_POST["board_cate"] !== '' ? $_POST["board_cate"] : (isset($_GET["board_cate"]) ? $_GET["board_cate"] : '');
	$board_group		= isset($_POST["board_group"]) && $_POST["board_group"] !== '' ? $_POST["board_group"] : (isset($_GET["board_group"]) ? $_GET["board_group"] : '');

	$list_group			= isset($_POST["list_group"]) && $_POST["list_group"] !== '' ? $_POST["list_group"] : (isset($_GET["list_group"]) ? $_GET["list_group"] : '');
	$read_group			= isset($_POST["read_group"]) && $_POST["read_group"] !== '' ? $_POST["read_group"] : (isset($_GET["read_group"]) ? $_GET["read_group"] : '');
	$write_group		= isset($_POST["write_group"]) && $_POST["write_group"] !== '' ? $_POST["write_group"] : (isset($_GET["write_group"]) ? $_GET["write_group"] : '');
	$reply_group		= isset($_POST["reply_group"]) && $_POST["reply_group"] !== '' ? $_POST["reply_group"] : (isset($_GET["reply_group"]) ? $_GET["reply_group"] : '');
	$comment_group	= isset($_POST["comment_group"]) && $_POST["comment_group"] !== '' ? $_POST["comment_group"] : (isset($_GET["comment_group"]) ? $_GET["comment_group"] : '');
	$link_group			= isset($_POST["link_group"]) && $_POST["link_group"] !== '' ? $_POST["link_group"] : (isset($_GET["link_group"]) ? $_GET["link_group"] : '');
	$upload_group		= isset($_POST["upload_group"]) && $_POST["upload_group"] !== '' ? $_POST["upload_group"] : (isset($_GET["upload_group"]) ? $_GET["upload_group"] : '');
	$download_group	= isset($_POST["download_group"]) && $_POST["download_group"] !== '' ? $_POST["download_group"] : (isset($_GET["download_group"]) ? $_GET["download_group"] : '');

	$secret_tf			= isset($_POST["secret_tf"]) && $_POST["secret_tf"] !== '' ? $_POST["secret_tf"] : (isset($_GET["secret_tf"]) ? $_GET["secret_tf"] : '');
	$search_tf			= isset($_POST["search_tf"]) && $_POST["search_tf"] !== '' ? $_POST["search_tf"] : (isset($_GET["search_tf"]) ? $_GET["search_tf"] : '');
	$like_tf				= isset($_POST["like_tf"]) && $_POST["like_tf"] !== '' ? $_POST["like_tf"] : (isset($_GET["like_tf"]) ? $_GET["like_tf"] : '');
	$unlike_tf			= isset($_POST["unlike_tf"]) && $_POST["unlike_tf"] !== '' ? $_POST["unlike_tf"] : (isset($_GET["unlike_tf"]) ? $_GET["unlike_tf"] : '');
	$realname_tf		= isset($_POST["realname_tf"]) && $_POST["realname_tf"] !== '' ? $_POST["realname_tf"] : (isset($_GET["realname_tf"]) ? $_GET["realname_tf"] : '');
	$ip_tf					= isset($_POST["ip_tf"]) && $_POST["ip_tf"] !== '' ? $_POST["ip_tf"] : (isset($_GET["ip_tf"]) ? $_GET["ip_tf"] : '');
	$comment_tf			= isset($_POST["comment_tf"]) && $_POST["comment_tf"] !== '' ? $_POST["comment_tf"] : (isset($_GET["comment_tf"]) ? $_GET["comment_tf"] : '');
	$reply_tf				= isset($_POST["reply_tf"]) && $_POST["reply_tf"] !== '' ? $_POST["reply_tf"] : (isset($_GET["reply_tf"]) ? $_GET["reply_tf"] : '');
	$html_tf				= isset($_POST["html_tf"]) && $_POST["html_tf"] !== '' ? $_POST["html_tf"] : (isset($_GET["html_tf"]) ? $_GET["html_tf"] : '');
	$file_tf				= isset($_POST["file_tf"]) && $_POST["file_tf"] !== '' ? $_POST["file_tf"] : (isset($_GET["file_tf"]) ? $_GET["file_tf"] : '');
	$file_cnt				= isset($_POST["file_cnt"]) && $_POST["file_cnt"] !== '' ? $_POST["file_cnt"] : (isset($_GET["file_cnt"]) ? $_GET["file_cnt"] : '');
	$max_title			= isset($_POST["max_title"]) && $_POST["max_title"] !== '' ? $_POST["max_title"] : (isset($_GET["max_title"]) ? $_GET["max_title"] : '');
	$new_hour				= isset($_POST["new_hour"]) && $_POST["new_hour"] !== '' ? $_POST["new_hour"] : (isset($_GET["new_hour"]) ? $_GET["new_hour"] : '');
	$hot_cnt				= isset($_POST["hot_cnt"]) && $_POST["hot_cnt"] !== '' ? $_POST["hot_cnt"] : (isset($_GET["hot_cnt"]) ? $_GET["hot_cnt"] : '');
	$reply_order		= isset($_POST["reply_order"]) && $_POST["reply_order"] !== '' ? $_POST["reply_order"] : (isset($_GET["reply_order"]) ? $_GET["reply_order"] : '');
	
	$board_badword	= isset($_POST["board_badword"]) && $_POST["board_badword"] !== '' ? $_POST["board_badword"] : (isset($_GET["board_badword"]) ? $_GET["board_badword"] : '');
...
<input type="hidden" name="nPageSize" value="<?=$nPageSize?>" />
				...
				<div class="cont">
					...
					<? if ($_SESSION["s_adm_no"] == $rs_reg_adm || $sPageRight_D == "Y") { ?>
