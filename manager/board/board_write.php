...
# Confirm right
#==============================================================================
	$writer_id	= $_SESSION["s_adm_id"];//작성자 아이디:로그인한 사용자 아이디
...
#=====================================================================
	...
	$homepage				= isset($_POST["homepage"]) && $_POST["homepage"] !== '' ? $_POST["homepage"] : (isset($_GET["homepage"]) ? $_GET["homepage"] : '');
	...
	$link01					= isset($_POST["link01"]) && $_POST["link01"] !== '' ? $_POST["link01"] : (isset($_GET["link01"]) ? $_GET["link01"] : '');
	$link02					= isset($_POST["link02"]) && $_POST["link02"] !== '' ? $_POST["link02"] : (isset($_GET["link02"]) ? $_GET["link02"] : '');
	$info_01				= isset($_POST["info_01"]) && $_POST["info_01"] !== '' ? $_POST["info_01"] : (isset($_GET["info_01"]) ? $_GET["info_01"] : '');
	$thumb_img			= isset($_POST["thumb_img"]) && $_POST["thumb_img"] !== '' ? $_POST["thumb_img"] : (isset($_GET["thumb_img"]) ? $_GET["thumb_img"] : '');
	...
	$thumb_nm					= isset($_POST["thumb_nm"]) && $_POST["thumb_nm"] !== '' ? $_POST["thumb_nm"] : (isset($_GET["thumb_nm"]) ? $_GET["thumb_nm"] : '');
	$thumb_rnm				= isset($_POST["thumb_rnm"]) && $_POST["thumb_rnm"] !== '' ? $_POST["thumb_rnm"] : (isset($_GET["thumb_rnm"]) ? $_GET["thumb_rnm"] : '');

	$old_thumb_nm			= isset($_POST["old_thumb_nm"]) && $_POST["old_thumb_nm"] !== '' ? $_POST["old_thumb_nm"] : (isset($_GET["old_thumb_nm"]) ? $_GET["old_thumb_nm"] : '');
	$old_thumb_rnm		= isset($_POST["old_thumb_rnm"]) && $_POST["old_thumb_rnm"] !== '' ? $_POST["old_thumb_rnm"] : (isset($_GET["old_thumb_rnm"]) ? $_GET["old_thumb_rnm"] : '');

	$file_flag				= isset($_POST["file_flag"]) && $_POST["file_flag"] !== '' ? $_POST["file_flag"] : (isset($_GET["file_flag"]) ? $_GET["file_flag"] : '');

	$recomm						= isset($_POST["recomm"]) && $_POST["recomm"] !== '' ? $_POST["recomm"] : (isset($_GET["recomm"]) ? $_GET["recomm"] : '');
				...
				<div class="cont">
					<div class="tbl_style01 left">
						...
						?>
							...
							<? if ($b_board_type == "NEWS") { ?>
							<tr>
								<th>보도자료 썸네일 <img src="../images/img_essen.gif" alt="필수입력" /></th>
								<td colspan="3">
								<?
								...
								?>
									<span class="tbl_txt"><span class="txt_c02">※  652 * 440</span></span>
								</td>
							</tr>
