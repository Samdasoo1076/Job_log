...
#	(하나의 변수 명에 POST, GET을 모두 사용한 페이지에서만 사용 기본으로는 해당 코드 없이 POST, GET 명시)
	...
	$flag						= isset($_POST["flag"]) && $_POST["flag"] !== '' ? $_POST["flag"] : (isset($_GET["flag"]) ? $_GET["flag"] : '');
	$sub_flag				= isset($_POST["sub_flag"]) && $_POST["sub_flag"] !== '' ? $_POST["sub_flag"] : (isset($_GET["sub_flag"]) ? $_GET["sub_flag"] : '');
	...
	$pre_b_no				= isset($_POST["pre_b_no"]) && $_POST["pre_b_no"] !== '' ? $_POST["pre_b_no"] : (isset($_GET["pre_b_no"]) ? $_GET["pre_b_no"] : '');
	$pre_b_code			= isset($_POST["pre_b_code"]) && $_POST["pre_b_code"] !== '' ? $_POST["pre_b_code"] : (isset($_GET["pre_b_code"]) ? $_GET["pre_b_code"] : '');
	$next_b_code		= isset($_POST["next_b_code"]) && $_POST["next_b_code"] !== '' ? $_POST["next_b_code"] : (isset($_GET["next_b_code"]) ? $_GET["next_b_code"] : '');
