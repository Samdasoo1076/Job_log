...
#===============================================================
	...
	$arr_rs_top = listBoardTop($conn, $b_code, $con_cate_01, $con_cate_02, $con_cate_03, $con_cate_04, $con_writer_id, $keyword, $con_reply_state, $con_use_tf, $del_tf, $search_field, $search_str, 5);
...
<script language="javascript">
	...
	function js_view3(b_code, b_no, b_board_type) {
...
$(document).on("click", ".cl_reply_state", function() {
	var bno = $(this).data("bno");
	$("#reply_state_"+bno).val($(this).val());
});


function js_reply_save(b, bn) {
	
	var reply = $("#reply_"+bn).val();
	var reply_state = $("#reply_state_"+bn).val();
