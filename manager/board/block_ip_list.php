...
#=====================================================================
	...
	if ($mode == "T") {
		updateBoardBlockIPUseTF($conn, $use_tf, $_SESSION['s_adm_no'], (int)$seq_no);
...
#===============================================================
	...
	$nListCnt = totalCntBoardBlockIP ($conn, $con_use_tf, $con_del_tf, $search_field, $search_str);
	...
	$arr_rs = listBoardBlockIP($conn, $con_use_tf, $con_del_tf, $search_field, $search_str, $nPage, $nPageSize);
...
<script type="text/javascript" >
	...
	function js_write() {
		...
		document.location.href = "block_ip_write.php?menu_cd="+menu_cd;
	}
