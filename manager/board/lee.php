					...
					<table>
						...
						<tbody>
							<tr>
								<th>회원 구분</th>
								<td colspan="1">
									<?= makeSelectBox($conn, "APPLY_TYPE", "m_ksic", "184", "선택", "", $APPLY_TYPE) ?>
								</td>
								<th>산업 분류</th>
								<td>
									<?= makeSelectBox($conn, "INDUSTRY_CATEGORY", "m_ksic", "184", "선택", "", $INDUSTRY_CATEGORY) ?>
								</td>
							</tr>
							<tr>
								<th>이메일수신동의</th>
								<td>
									<?= makeSelectBox($conn, "USE_TF", "m_ksic", "184", "선택", "", $USE_TF) ?>
								</td>
					...
					<table id='t'>
						...
						<thead>
							<tr>
								...
								<th scope="col">메일 수신</th>
								<th scope="col">문자 수신</th>
							</tr>
							<?
							$nCnt = 0;
