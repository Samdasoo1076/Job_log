...
#====================================================================
	if ($mode == "I") {
		...
		if ($result == 0) {
			...
			$result = insertDcode($conn, $pcode, $dcode, $dcode_nm, $dcode_ext, $dcode_seq_no, $use_tf, $_SESSION['s_adm_id']);
	...
	if ($mode == "U") {
		...
		$result = updateDcode($conn, $pcode, $dcode, $dcode_nm, $dcode_ext, $use_tf, $_SESSION['s_adm_id'], $dcode_no);
		$mode = "R";
	...
	if ($mode == "T") {
		...
		$result_no = updateDcodeUseTF($conn, $use_tf, $_SESSION['s_adm_id'], $pcode, $dcode_no);
	...
	if ($mode == "D") {
		...
		$result = deleteDcode($conn, $_SESSION['s_adm_id'], $pcode, $dcode_no);
		$mode = "R";
...
#pop_table_scroll { z-index: 1;  overflow: auto; height: 350px; }
-->
</style>
<script language="javascript">
