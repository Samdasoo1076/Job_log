...
<script type="text/javascript" >
	...
	$(document).on("click", "#btn_prev", function() {
		document.location = "holiday.php?year=<?=$pre_year?>&month=<?=$pre_month?>";
	});

	$(document).on("click", "#btn_next", function() {
		document.location = "holiday.php?year=<?=$next_year?>&month=<?=$next_month?>";
	});
...
<input type="hidden" name="month" value="<?=$month?>">
			...
			<div class="cont">
				<div class="tit_h4 first"><h4>달력보기</h4></div>
...
?>
									<span class="date"><a href="javascript:js_add_holiday('<?=$year?>-<?=$month?>-<?=$day_?>');"><font color="<?=$str_color?>"><?echo $str_firstDay?></font></a></span>
