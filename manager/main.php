...
#=====================================================================
	...
	$rs_reservation_count = getReservationCount($conn);
				...
				yAxes: [{
					ticks: {
						...
						<div class="chart count">
							<div class="conTitle"><strong>누적 방문자 수</strong></div>
							<div class="sp5"></div>
							...
							<div class="conTitle"><strong>시설 예약 현황</strong></div>
							<div class="sp5"></div>
							<table class="chart_tbl">
								<colgroup>
									<col width="*">
								...
								<tr>
									<th><a href="#">시설 예약</a></th>
									<td><strong><font color='red'><?=number_format($rs_reservation_count[0]["A1"])?></font></strong></td>
									<td><?=number_format($rs_reservation_count[0]["A2"])?></td>
								</tr>
							</table>
