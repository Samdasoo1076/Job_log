...
#==============================================================================
	...
	$con_divicetype			= $_POST['con_divicetype']!=''?$_POST['con_divicetype']:$_GET['con_divicetype'];
...
#==============================================================================
	...
	$arr_rs = listDayPeriod($conn, $start_date, $end_date, $con_divicetype);
...
<input type="hidden" name="nPageSize" value="<?=$nPageSize?>">
				...
				<div class="cont">
					...
					<div class="tbl_top">
						<div class="left"><span class="txt">총 <span class="txt_c01"><?=number_format(sizeof($arr_rs))?></span> 일</span></div>
						<div class="right">
					...
					<div id="chart-area" style="width:100%;border:solid #fff"></div>
...
<link rel="stylesheet" type="text/css" href="../css/toastui-chart.min.css" media="all" />
...
<script>
	...
	const data = {
			...
			series: [
				{name: 'Budget',data: [5000, 3000, 5000, 7000, 6000, 4000, 1000],},
				{name: 'Income',data: [8000, 4000, 7000, 2000, 6000, 3000, 5000],},
				{name: 'Expenses',data: [4000, 4000, 6000, 3000, 4000, 5000, 7000],},
				{name: 'Debt',data: [3000, 4000, 3000, 1000, 2000, 4000, 3000],},
			],
	};
	const options = {
		chart: { title: 'Monthly Revenue', width: 1600, height: 400 },
	};
