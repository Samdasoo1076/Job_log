			...
			<div class="contents">
				...
				<form id="bbsList" name="frm" method="post" action="javascript:js_search();">
					...
					<div class="cont">
										...
										<td colspan="3">
											<div class="datepickerbox" style="width:120px;">
												<select name="con_divicetype">
													...
													<option value="P" <? if ($con_divicetype == "P") { ?>selected<? } ?>>
														PC</option>
													<option value="M" <? if ($con_divicetype == "M") { ?>selected<? } ?>>
														Mobile</option>
												</select>
											</div>
											<div class="datepickerbox" style="width:120px;">
												<input type="text" id="start_date" name="start_date"
													value="<?= $start_date ?>" class="datepicker" style="width:120px"
													readonly="1" />
											</div>
											<span class="tbl_txt"> ~ </span>
											<div class="datepickerbox" style="width:120px;">
												<input type="text" id="end_date" name="end_date" value="<?= $end_date ?>"
													class="datepicker" style="width:120px" readonly="1" />
											</div>
											<div class="datepickerbox" style="width:120px;">
						...
						<div class="tbl_top">
							<div class="left"><span class="txt">총 <span
										class="txt_c01"><?= number_format(sizeof($arr_rs)) ?></span> 일</span></div>
							<div class="right">
								...
								<tbody>
									...
									if (sizeof($arr_rs) > 0) {
										...
										<tr bgcolor="#EFEFEF">
											...
											<td style="text-align:right;padding-right:10px"><?= number_format($TOT_UVPV) ?>
											</td>
										</tr>
									<?
									} else {
