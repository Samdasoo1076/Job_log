...
# =============================================================================
# File Name    : period_notice_list.php
# Modlue       : 
# Writer       : Park Chan Ho 
...
#==============================================================================
	...
	$result_log = insertUserLog($conn, 'admin', $_SESSION['s_adm_id'], $_SERVER['REMOTE_ADDR'], "공지 계시글 접속통계 조회", "List");
...
<script language="javascript">
	...
	function js_search() {
		...
		frm.method = "get";
		frm.target = "";
		frm.action = "period_notice_list.php";
		frm.submit();
	}
...
<input type="hidden" name="nPageSize" value="<?=$nPageSize?>">
				...
				<div class="cont">
					...
					<div class="tbl_top">
						<div class="left"><span class="txt">총 <span class="txt_c01"><?=number_format(sizeof($arr_rs))?></span> 건</span></div>
						<div class="right">
						...
						<table>
							...
							?>
								<tr> 
									...
									<td style="text-align:left;padding-left:10px"><a href="/notice/view.php?bn=<?=$PARAM02?>&m_type=<?=$CATE?>&nPage=1&f=&s=" target="_blank"><?=$TITLE?></a></td>
									<td><?=$REG_DATE?></td>
