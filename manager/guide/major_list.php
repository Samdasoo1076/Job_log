...
#====================================================================
	...
	if ($mode == "D") {
		...
		for ($k = 0; $k < $row_cnt; $k++) {
			...
			$result_log = insertUserLog($conn, 'admin', $_SESSION['s_adm_id'], $_SERVER['REMOTE_ADDR'], "학과 및 전공 삭제 (".$tmp_idx.") ", "Delete");
		}
	}
...
#===============================================================
	...
	$result_log = insertUserLog($conn, "admin", $_SESSION['s_adm_id'], $_SERVER['REMOTE_ADDR'], "학과 및 전공 리스트 조회", "List");
...
<script type="text/javascript" >
	...
	function js_add_mojib() {
		document.location = "major_write.php";
	}
			...
			<input type="hidden" name="use_tf" value="">
					...
					<div class="tbl_top">
						...
						<div class="right">
							...
							<option value="M_TYPE" <? if ($search_field == "M_TYPE") echo "selected"; ?> >구분</option>
						...
						<table>
							...
							?>
									<tr>
										...
										<td><a href="javascript:js_view('<?=$M_NO?>');"><?=$M_YEAR?></a></td>
										<td><a href="javascript:js_view('<?=$M_NO?>');"><?=$M_TITLE?></a></td>
										<td><a href="../../_common/new_download_file.php?menu=major&m_no=<?=$M_NO?>&field=m_pdf" target="_blank"><?=$M_PDF_NAME?></a></td>
