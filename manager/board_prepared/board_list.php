...
#===============================================================
	...
	$arr_rs_top = listBoardTop($conn, $b_code, $con_cate_01, $con_cate_02, $con_cate_03, $con_cate_04, $con_writer_id, $keyword, $reply_state, $con_use_tf, $del_tf, $search_field, $search_str, 0);

	$arr_rs_main = listBoardMain($conn, $b_code, $con_cate_01, $con_use_tf, $del_tf, $nListCnt);
