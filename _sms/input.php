...
<body onload="loadJSON()">
	<form method="post" name="smsForm" action="calljson.php">
		...
		전송메세지 <textarea name="msg" cols="30" rows="10" style="width:455px;">찬호폰으로내용입력</textarea>
		<br /><br /><p>단문(SMS) : 최대 90byte까지 전송할 수 있으며, 잔여건수 1건이 차감됩니다. <br />
			장문(LMS) : 한번에 최대 2,000byte까지 전송할 수 있으며 1회 발송당 잔여건수 3건이 차감됩니다.
		</p>
		<br />받는 번호 <input type="text" name="rphone" value="010-5226-4159"> 예) 011-011-111 , '-' 포함해서 입력.
		<br />이름삽입번호 <input type="text" name="destination" value="" size=80> 예) 010-000-0000|홍길동
		<br />
			보내는 번호 <input type="hidden" name="sphone1" value="033">
		<input type="hidden" name="sphone2" value="764">
		<input type="hidden" name="sphone3" value="9020">
