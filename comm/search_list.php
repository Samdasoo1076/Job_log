...
<script language="javascript">
    $(document).ready(function () {
        ...
        function fetchResults(page) {
            ...
            const nRowCount = 20; // 페이지당 표시할 데이터 수
                        ...
                        $.each(response.data, function (index, item) {
                            ...
                            <li>
                                <a href="/communication/view.php?b=${item.B_CODE}&bn=${item.B_NO}">
                                    ...
                                    <div class="cont">${highlightedContent}</div>
        ...
        <div class="content-body search-wrap">
            ...
            <div class="board-list-page">
                ...
                <div class="title-wrap">
                    ...
                    <p class="explain" id="search-info"><em class="search" id="search-keyword"></em>에 대한 검색 결과 <em class="num" id="search-count">0</em>건의 검색결과를 찾았습니다.</p>
                </div>
                <!-- // 타이틀 영역 -->
