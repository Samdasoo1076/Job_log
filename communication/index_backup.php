						...
						<form class="board-srch" id="form" name="frm" onSubmit="js_board_search();" method="get">
							...
							<? if ($b == "B_1_5") { ?>
								<div class="frm-sel h-48">
									<select name="rss" id="rss" onChange="blur();" title="검색 구분" class="sel">
										<option value="ALL" <? if ($f == "ALL") echo "selected"; ?>>전체</option>
										<option value="<?= $_SESSION['rss'] ?>" <? if ($f == $_SESSION['rss']) echo "selected"; ?>>공고명</option>
									</select>
								</div>
							<? } else if ($b == "B_1_11") { ?>
								<div class="frm-sel h-48">
