...
/**
	...
	function validateForm() {
		...
		$("#rv_reduction_tf").val(rvReductionRadio.value);

		$("#Rv_end_time").val($('#abled_time option:selected').text());
		...
		return true; // 모든 유효성 검사가 통과되면 폼 제출 허용
}
	// 버튼 활성화 함수
													...
													<div class="field">
														...
														<div class="info-inp-wrap">
															<div class="inp-wrap">
																...
																<input type="hidden" name="rv_reduction_tf" value="">
															</div>
															<div class="inp-wrap">
																<div class="frm-sel h-48">
